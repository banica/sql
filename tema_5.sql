...
7) Scrieți o instrucțiune SQL prin care să afișați clienții al căror nume (contactLastName) are unul din sufixele 'en' sau 'on' (câmpuri afișate: contactLastName, contactFirstName, phone). 
Rezultatele vor fi ordonate alfabetic după contactLastName și contactFirstName.
